  ...
  test "unresolvable placeholder in command raises error" do
    ...
    def test_proc(data):
        process(
            ...
            inputs  = {"input": data},
            outputs = {"result": "s3://bucket/out.txt"},
  ...
  test "invalid URI scheme (http://) raises error" do
    ...
    def test_proc(data):
        process(
            ...
            command = "process {input} -o {result}",
            inputs  = {"input": data},
            outputs = {"result": "http://bucket/out.txt"},
            resources = {"cpu": 1, "mem": 2.0, "disk": 10.0},
        )
  ...
  test "valid s3:// URI scheme" do
    ...
    def test_proc(data):
        process(
            ...
            command = "process {input} -o {result}",
            inputs  = {"input": data},
            outputs = {"result": "s3://my-bucket/output/file.txt"},
            resources = {"cpu": 1, "mem": 2.0, "disk": 10.0},
        )
  ...
  test "valid gs:// URI scheme" do
    ...
    def test_proc(data):
        process(
            ...
            command = "process {input} -o {result}",
            inputs  = {"input": data},
            outputs = {"result": "gs://gcs-bucket/output/file.txt"},
            resources = {"cpu": 1, "mem": 2.0, "disk": 10.0},
        )
  ...
  test "valid nfs:// URI scheme" do
    ...
    def test_proc(data):
        process(
            ...
            command = "process {input} -o {result}",
            inputs  = {"input": data},
            outputs = {"result": "nfs://server/path/file.txt"},
            resources = {"cpu": 1, "mem": 2.0, "disk": 10.0},
        )
  ...
  test "valid relative path (.) in output" do
    ...
    def test_proc(data):
        process(
            ...
            command = "process {input} -o {result}",
            inputs  = {"input": data},
            outputs = {"result": "./output/file.txt"},
            resources = {"cpu": 1, "mem": 2.0, "disk": 10.0},
        )
  ...
  test "valid absolute path (/) in output" do
    ...
    def test_proc(data):
        process(
            ...
            command = "process {input} -o {result}",
            inputs  = {"input": data},
            outputs = {"result": "/data/output/file.txt"},
            resources = {"cpu": 1, "mem": 2.0, "disk": 10.0},
        )
  ...
  test "output URI can use property notation like {data.stem}" do
    ...
    def test_proc(data):
        process(
            ...
            inputs  = {"data": data},
            outputs = {"result": "s3://bucket/{data.stem}.out.txt"},
            resources = {"cpu": 1, "mem": 2.0, "disk": 10.0},
        )
